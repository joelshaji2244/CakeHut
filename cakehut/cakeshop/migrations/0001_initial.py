...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('weight', models.CharField(choices=[('250g', '250g'), ('500g', '500g'), ('1kg', '1kg'), ('1.5kg', '1.5kg'), ('2kg', '2kg')], default='1kg', max_length=100)),
                ('price', models.PositiveIntegerField()),
                ('cake', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cakeshop.cakes')),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cakevarient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cakeshop.cakevarients')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cakevarient', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='cakeshop.cakevarients')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
